...
async function fetchAPI() {
  ...
  // try {
  //   const response = await fetch("https://opendata.paris.fr/api/explore/v2.1/catalog/datasets/stationnement-en-ouvrage/records?limit=100&start=0", {
  //     method: 'GET',
  //     headers: {
  //       'Content-Type': 'application/json'
  //     }
  ...
  //   const response2 = await fetch("https://opendata.paris.fr/api/explore/v2.1/catalog/datasets/stationnement-en-ouvrage/records?start=100&limit=100", {
  //     method: 'GET',
  //     headers: {
  //       'Content-Type': 'application/json'
  //     }
  ...
  //   resultat = resultat.results.concat(resultat2.results);
